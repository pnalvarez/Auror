...
/// Home tab content for [HomePage] (no ViewModel / router).
class HomeBody extends StatelessWidget {
  const HomeBody({
    ...
    required this.tomorrowRevisionsCount,
    required this.dailyIdeaCards,
    required this.dailyIdeaProgress,
    required this.dailyIdeaTotal,
    required this.onDailyIdeaCtaTap,
  ...
  final int dailyIdeaCards;
  final int dailyIdeaProgress;
  final int dailyIdeaTotal;
  final VoidCallback onDailyIdeaCtaTap;
      ...
      child: Column(
        ...
        children: [
          _HomeHeader(
            ...
            totalTimeToLearnDailyIdea: totalTimeToLearnDailyIdea,
          ),
          const SizedBox(height: AppSpacings.xl3),
          _SectionHeader(
            title: homeSectionPendingRevisions,
            icon: Icons.psychology_rounded,
            badgeText: revisions.length.toString(),
          ),
          const SizedBox(height: AppSpacings.l),
          _HomeRevisionSection(
            revisions,
            tomorrowRevisionsCount,
            onSeeMoreRevisions,
          ),
          const SizedBox(height: AppSpacings.xl3),
          _SectionHeader(
          ...
          ListItem(
            input: TitleDescriptionCTAProgressInput(
              ...
              description: homeDailyIdeaDescription(dailyIdeaCards),
              ctaText: homeDailyIdeaCta,
              onCtaTap: onDailyIdeaCtaTap,
              currentProgress: dailyIdeaProgress,
              totalProgress: dailyIdeaTotal,
            ),
          ),
        ],
      ),
