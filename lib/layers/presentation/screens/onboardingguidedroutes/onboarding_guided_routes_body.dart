...
/// Guided routes marketing + CTA for [OnboardingGuidedRoutesPage].
class OnboardingGuidedRoutesBody extends StatelessWidget {
  const OnboardingGuidedRoutesBody({super.key, required this.onEnterApp});
