...
/// Learning loop explainer for [OnboardingLearningLoopPage].
class OnboardingLearningLoopBody extends StatelessWidget {
  const OnboardingLearningLoopBody({super.key, required this.onNext});
