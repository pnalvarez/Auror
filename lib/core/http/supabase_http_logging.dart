...
/// `--dart-define=VERBOSE_SUPABASE_HTTP=true` (e.g. profile logging).
...
/// Wraps an [http.Client] and prints full request/response details for Supabase.
///
/// Masks `Authorization` values in logs. Truncates very large bodies to avoid
